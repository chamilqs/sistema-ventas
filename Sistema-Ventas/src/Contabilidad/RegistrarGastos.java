 ...
 * @author Angelo
 */
public class RegistrarGastos extends javax.swing.JDialog {

    int xMouse, yMouse;
    TabContabilidad tb = new TabContabilidad();
    
    public RegistrarGastos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//
      LocalDateTime now = LocalDateTime.now();
//    Timestamp fecha = Timestamp.valueOf(now);

   // pst.setTimestamp(1, java.sql.Timestamp.valueOf(u.getLogout()));
    ...
    try (Connection connection = Conexion.conectar();
        ...
        preparedStatement.setTimestamp(3, java.sql.Timestamp.valueOf(now));
