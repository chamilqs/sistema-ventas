...
import static appStructure.application.form.other.Ventas.FormFacturacion.tablaProductosVentas;
...
public class DeudaClientes extends javax.swing.JDialog {
    ...
    public DeudaClientes() {
        initComponents();
        setModal(true);
        fv = new FormFacturacion(); // Inicializar la instancia de FacturacionVenta
